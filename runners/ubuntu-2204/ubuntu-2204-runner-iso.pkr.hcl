...
variable "iso_url" {
  type        = string
  description = "Ubuntu 22.04 live server ISO URL"
  default     = "https://releases.ubuntu.com/22.04/ubuntu-22.04.5-live-server-amd64.iso"
}

variable "iso_file" {
  type        = string
  description = "Existing Proxmox ISO path (example: local:iso/ubuntu-22.04.5-live-server-amd64.iso). When set, iso_url is ignored."
  default     = ""
}
